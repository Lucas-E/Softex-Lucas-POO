...
export default function Home() {
  ...
  return (
    ...
    <div className="fixed bottom-0 rounded w-screen flex justify-around">
      <input type="text" className="border p-5 w-full" placeholder="digite sua mensagem" onChange={handleMessage} value={typedMessage}/>
      <button onClick={handleSendMessage} className="border rounded p-5 bg-blue-600 active:bg-blue-800 text-white " type="button" >teste</button>
    </div>
    </>
  )
}
